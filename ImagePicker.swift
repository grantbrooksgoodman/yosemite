...
#warning("CHANGE PERMISSION STRINGS UPON RELEASE!")
...
open class ImagePicker: NSObject
{
    ...
    var displayRemove = false
    var presentingImageView = 0
    ...
    public func present(from sourceView: UIView)
    {
        ...
        let removeAction = UIAlertAction(title: "Remove Current Photo", style: .destructive)
        { [unowned self] _ in
