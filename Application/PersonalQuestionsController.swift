...
class PersonalQuestionsController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        for question in questionTitles {
            ...
            } else { /*If none of the above applied, i.e.
    ...
    @IBAction func doneButton(_ sender: Any) {
        ...
        GenericSerializer().updateValue(onKey: "/allUsers/\(currentUser!.associatedIdentifier!)/", withData: ["questionsAnswered": currentUser!.serializeQuestionsAnswered()]) { (setValueError) in
    ...
    func toggleCheckmark(_ forShadowButton: ShadowButton, isChecked: Bool) {
        if isChecked {
            ...
            forShadowButton.initializeLayer(animateTouches: false,
                                            backgroundColor: UIColor(hex: 0x60C129),
                                            customCornerRadius: nil,
            ...
            forShadowButton.initializeLayer(animateTouches: false,
                                            backgroundColor: .orange /*UIColor(hex: 0xE95A53)*/,
                                            customCornerRadius: nil,
                                            shadowColor: UIColor.clear.cgColor)
        }
    }
...
extension PersonalQuestionsController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            GenericSerializer().updateValue(onKey: "/allUsers/\(currentUser!.associatedIdentifier!)/", withData: ["questionsAnswered": currentUser!.serializeQuestionsAnswered()]) { (updateValueError) in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        } else { //If the index path is for the unanswered questions.
